 ...
 */
package Tugas.Bagus.guitugas;

/**
 *
 * @author ROG SERIES
 */
public class KalkulatorJava1841720146Bagus extends javax.swing.JFrame {
     ...
     */
    public KalkulatorJava1841720146Bagus() {
        initComponents();
    }
    ...
    private void getOperatorBagus(String btnText){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(KalkulatorJava1841720146Bagus.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new KalkulatorJava1841720146Bagus().setVisible(true);
            }
        });
    }
